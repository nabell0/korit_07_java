...
/*
    ...
    그럼 Exception01에서 알 수 있듯이, 다수의 예외의 경우에는 이미 개발자들이 정의를 해놓음.
    예를 들어 List를 하나 정의했고, 거기에 element들을 집어넣었다고 가정한다면.
    그 경우에 List의 element들을 추출하기 위해서 반복문을 쓰게 될텐데,
    i < strList.size()를 쓰지 않고 i< 3001 과 같은 방식으로 하드코딩을 했을 때에만 예외가
    발생하겠죠.

    그리고 여러분들은 향상된 for문을 배웠기 때문에, 이를 사용한다면 예외를 볼 일이 전혀 없음.
...
public class Exception01 {
    public static void main(String[] args) {
        ...
        person1.name = "김일";
        person1.age = 20;
//        person1.school = "코리아아이티";        IDE상에서 예외처리가 아니라 빨갛게 나오는 예시 #1
        person1.showInfo();
        //
...
//        int b = 0;
//        try {
//            int result = a / b;     // ArithmeticException 예외 발생 지점 -> 36번 라인이 아니라 catch문으로 넘어감.
...
//        }
        ...
        /*
            ...
            저희가 if문(leep year 관련)에 대해서 작성할 때
