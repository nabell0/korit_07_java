...
public class StrMap {
    public static void main(String[] args) {
        ...
        koreanscores2.put("김일", 87.2);
        koreanscores2.put("김이", 46.1);
        koreanscores2.put("김삼", 65.7);
        koreanscores2.put("김사", 4.5);
        koreanscores2.put("김오", 100.0);

        //특정 key의 vlalue 수정
        // # 1. 아까 말한 것처럼 key에는 value가 하나 밖에 없기 때문에 최근걸로 덮어쓰기 됨.
...
//        List<Map.Entry<String, String>> entryList2 = strMap1.entrySet();
        ...
        System.out.println(entryList1); // list로 바뀌었으니깐 element 추출이 가능.
        ...
        // Value Set 출력
//        Set<String> valueSet = strMap1.values();  이게 불가능한 이유는 ?
        /*
