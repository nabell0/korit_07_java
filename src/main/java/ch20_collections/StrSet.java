...
/*
    ...
    List -> Set / 혹은 Set -> List로의 형변환이 중요함.
    ...
    그래서 Set은 우리가 중 1 때 배우는 집합 개념과 유사.
...
public class StrSet {
    public static void main(String[] args) {
        // Set 객체 생성
        Set<String> strSet = new HashSet<>();   // 뻘건거 떳을 때 alt + enter
        // List 객체도 생성
        List<String> strList = new ArrayList<>();

        // List / Set에 element 추가하는 방법은 동일. 리스트or셋명.add(element);
        strList.add("java");
        strList.add("java");
        strList.add("java");
        strList.add("python");
