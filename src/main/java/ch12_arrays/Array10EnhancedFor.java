...
public class Array10EnhancedFor {
    public static void main(String[] args) {
        ...
        //일반 for문 형태로 1 2 3 4 5 6 ...200으로 출력.
        ...
        for (int number : nums){// int[]
            ...
            // 대입이 된 상태로 40번 라인을 실행 "1 " 까지 출력.
            // 그 다음 반복으로 넘어가서 nums의 두번째 element인 2를 numver에 대입
            // 39번 실행
            //다음 3 대입
            // 39 실행
            //...200 대입
...
/*
    개발자들이 자기가 일일이 코드 치는 경우도 많겠지만 남의 거 보고 수정하거나 유지보수하는 일이 많음.
    Java를 기준으로 봤을 때
 */