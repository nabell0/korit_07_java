...
public class JSON2 {
    public static void main(String[] args) {
        ...
        // 하나는 한 줄로 출력.
        // 하나는 prettyPrinting 적용시켜서 출력 상의 차이를 확인해보기 위해 두 개 만듬.

        //1. Java Object -> json으로 변환
        /*
            user1 객체를 생성하고, kim1 / 9876 / a@test.com / 김일 / 20 의 필드값을 가지도록
            하시오.
            그리고 JSON1.java 파일을 참조해서 json 데이터를 바꿔보시오.
        ...
        /*
            ...
            잘 생각해보면 jsonUser1을 선언할 때 자료형을 String으로 잡았습니다.
