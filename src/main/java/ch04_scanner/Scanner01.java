...
//        name = scanner.nextLine();
        /*
            ...
            2. nextLine / nextInt / ___이런 것들이 있겠다. 구분해야겠다.
         */
//        System.out.println("연도를 입력하세요. >>>> ");
//        int year = scanner.nextInt();
//        System.out.println("이름을 다시 입력하세요 >>> ");
//        name = scanner.next(); //입력
//        System.out.println(name);
        /*
            2. next(Int / double,...etc) vs . nextLine
                - nextLine은 띄어쓰기를 허용합니다. enter 키. 즉 개행을 기준으로 데이터가 변수
                - nextLine은 띄어쓰기를 허용합니다. -> 그래서 24번라인 실행 결과가 ahn
                - 나머지는 허용 안함
         */
...
//        System.out.println("이름 : "+ name);
        ...
        /*
            이상의 코드에서의 문제점은 34번 라인이 실행되었을 때 데이터를 입력 받지 않고
            그대로 넘어간다는 점
            이유는 nextLine()에서 값을 입력하고 저희가 enter를 치게 되는데,
            그 경우 다음 nextLine()에서는 enter키를 받아들여서 빈값인 상태로 enter를 쳤다고
            인지하게 되기 때문에
            곧장 35번 출력문으로 넘어갔기 때문입니다.

            해결 방법 : enter 키를 받아주는 nextLine()을 하나 더 만들기.
         */
//        System.out.print("올해는 몇 년도인가요? >>> ");
//        int year = scanner.nextInt();
//
//        scanner.nextLine(); //enter키를 자동으로 인식하는것을 배리어 역할을 하는 nextLine()
//        //얘는 사용되지 않을거니까 변수에 대입하지 않는다.
//
//        System.out.print("당신의 이름은? >>> ");
//        String name = scanner.nextLine();
//        System.out.println("연도 : " + year);
