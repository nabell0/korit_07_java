...
public class LambdaExample {
    public static void main(String[] args) {
        ...
        runnable.run(); //이상의 방법은 메서드명이 명시도니까 편한데,

        Runnable lambdaRunnable = () -> System.out.println("Hello, Lambda");
        lambdaRunnable.run(); // 얘는 윗줄을 봐도 메서드명이 없음. 아까 add / sub에서
        // calculate를 추론할 수 없었떤 이유 중에 하나.
        ...
        stringConsumer.accept("오늘 전반적인 수업 내용은 여기서 끝냅니다.");
    }
}
