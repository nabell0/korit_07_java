...
public class TeacherMain {
    public static <methods> void main(String[] args) {
        ...
        //Teacherr에서 .equals()를 재정의하기 전에는 false가 떴었습니다.
        //그때의 경우는 teacher1 과 teacher2의 주소지까지를 확인하여
        //같은지 아닌지의 여부를 판단했다면,
        //재정의 이후에는 field에 입력된 데이터가 동일한지만을 체크하기 때문.

        Class tClass = teacher1.getClass(); // 지난 시간에 하긴 했음.
        ...
        System.out.println(fields);     //결과 값 : [Ljava.lang.reflect.Field;@681a9515
