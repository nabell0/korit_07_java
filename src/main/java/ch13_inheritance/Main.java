...
public class Main {
    public static void main(String[] args) {
        ...
        human1.move();
        human1.setAnimalName("박현우");
        human1.setAnimalAge(31);
        String humanName = human1.getAnimalName();
        int humanAge = human1.getAnimalAge();
        System.out.println("안녕하세요,제 이릉은 "+ humanName+"이고 나이는 "+ humanAge + "살 입니다.");
        System.out.println("내년에는 "+ (++humanAge)+"살이 됩니다.");
        human1.reading("자바의 기초");
    }
