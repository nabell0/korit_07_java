...
/*
    ...
    거기서 오류가 하나라도 발생하게되면 전체 프로그램이 실행x
...
public class Main {
    public static void main(String[] args) {
        System.out.println("안녕하세요, 제 이름은 박현우입니다.");
//        System.out.println(안녕하세요, 제 이름은 박현우입니다.);// 오류발생
        ...
        String introduction = "안녕하세요, 저는 이번 국비 과정을 듣게 된 박현우입니다";
        ...
        /*
            Java에서의 변수 명명 규칙 :
                ...
                (snake case)라고 해서 my_test_result와 같은 방식

         */
        System.out.println(scoreEnglish);
//        변수 - 값이 바뀔 수 있음
        scoreEnglish = 90;            // 재대입할 때는 자료형 명시x
        System.out.println(scoreEnglish);
        ...
        char name2 = '현';
        char name3 = '우';
        System.out.println(name1 + name2 + name3); // 결과값 : 153801
        System.out.println('박'+'현'+'우'); // 153801
        ...
        /*
            ...
            때문에 원하는 방식으로 출력되지 않는다.
            
            그렇기 때문에 74번 라인에서 sout()의 () 내부에 ""를 넣어주니까,
            원하는 결과값을 얻을 수 있었다.
            
            즉 작은따옴표('')는 '문자'를 표기하기 위한 기호
        ...
        int width1 = 100;
        int width2 = 200;
        System.out.println(width1+width2); //숫자 변수는 연산이 가능하다
        String width3 = "300";
        String width4 = "400";
        ...
        Integer width5 = 500;
        Integer width6 = 600;
        System.out.println(width5+width6);// 근데 대문자로 시작하는 Integer가 있다.
        ...
        System.out.println("안녕하세요, 제 이름은" + name + "입니다. 제 전공은"+ major +"이고, 그래서 제 예전 직업은 " + previousJob + "였습니다."+ currentJob + "을 가지고 있습니다.");

        //이상의 코드에서 알 수 있는 점은 + literal의 형태로도 작성이 가능하다는점
        ...
        * 저는 코리아 it 아카데미 7월 국비과정을 수강하고있는 --입니다.--살입니다. ->줄바꿈
        * 제 전공은 --학과이며, mbti는 --입니다. 열심히 할게요!!!
        * 와 같이 출력될 수 있도록 sout 작성
        *
         */
        name10 ="박현우";
        major10 = "이탈리아어과";
        ...
        age10 = 31;
        // sout 두 번써서 개행하는 방법
        System.out.println("저는 코리아 it 아카데미 7월 국비과정을 수강하고 있는"+ name10 + "입니다." + age10 + "살 입니다.");
        System.out.println("제 전공은" + major10 + "학과이며, mbti는" + mbti10+"입니다. 열심히 할게요!!!");
        // sout 한 번 써서 개행하는 방법
        // enter 키 위에 역슬래시
        // \n -> 개행이 일어납니다.
        // \t -> 탭 친 효과가 일어난다.
